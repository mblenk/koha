...
--
-- Table structure for table `embedding_providers`
--
...
CREATE TABLE `llm_providers` (
  ...
  `api_key`               text         DEFAULT NULL COMMENT 'Bearer token for authentication',
  `auth_type`             enum('none','bearer') NOT NULL DEFAULT 'none' COMMENT 'Whether to send an Authorization header',
  `request_body_template` text         NOT NULL COMMENT 'JSON body template with {{model}}, {{messages}}, and {{system_prompt}} as sentinel values',
